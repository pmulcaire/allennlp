...
class SemanticRoleLabeler(Model):
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        lang_string = "shared" + "_".join(languages)
        self.conll_metric = ExternalConllEval(vocab, filename=lang_string, ignore_classes=["V"])
    ...
    def forward(self,  # type: ignore
        ...
        lang_encoder = self.lang_encoders[langid_val]
    ...
    def cuda(self, device_id=None):
        ...
        for lang_encoder in self.lang_encoders:
            lang_encoder.cuda(self.dev_id)

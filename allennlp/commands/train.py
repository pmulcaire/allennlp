...
from allennlp.data import Dataset, Vocabulary, MapVocabulary
...
def train_model(params: Params, serialization_dir: str) -> Model:
    ...
    vocab = MapVocabulary.from_params(params.pop("vocabulary", {}),
                                      Dataset([instance for dataset in all_datasets
                                               for instance in dataset.instances]))
    vocab.save_to_files(os.path.join(serialization_dir, "vocabulary"))

    #vocab2 = MapVocabulary.from_files(serialization_dir + '/vocabulary')
